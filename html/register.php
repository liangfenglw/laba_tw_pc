			...
			<div class="form_reg">
				<form method="" action="" id="form_3">
					<div class="item_r clearfix">
						<span class="spl">姓名：</span>
						<div class="divr">
							<input type="text" name="pname" class="txt1" />
						</div>
					</div>
					<div class="item_r clearfix">
					...
					<div class="item_r clearfix">
						<span class="spl">证件号：</span>
						<div class="divr">
							<select name="zhengjian_type" class="sel1" style="width:auto;">
								<option value="1">居民身份证</option>
								<option value="2">驾驶证</option>
								<option value="3">居住证</option>
								<option value="4">......</option>
							</select>
							<input type="text" name="zhengjian_num" class="txt1" style="width:235px;" />
						</div>
					</div>
					<div class="item_r clearfix">
						<span class="spl">证件扫描件：</span>
						<div class="divr">
							<input type="file" name="zhengjian_img" class="" />
